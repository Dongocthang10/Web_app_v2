...
interface SwitchProps {
  checked: boolean; // Xác định kiểu boolean cho checked
  onChange: () => void; // Xác định kiểu function cho onChange
}
        ...
        <div className="slider">
          <div className="circle">
            ...
            <svg className="checkmark" viewBox="0 0 24 24" height={10} width={10} xmlns="http://www.w3.org/2000/svg">
              <g>
                <path className="icon-path" data-original="#000000" fill="currentColor" d="..." />
              </g>
            </svg>
          </div>
        </div>
